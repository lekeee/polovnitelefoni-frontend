...
import { ArrowRightCircle, Eye, LockKeyhole, SmartphoneCharging, User } from "lucide-react";
...
export default function LoginPage() {
    return <>
        ...
        <div className="relative">
            <section className="w-full max-w-7xl px-5 py-24 mx-auto">
                <div className="w-full max-w-lg bg-white shadow-soft p-8 mx-auto rounded-2xl flex flex-col gap-4 relative">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <p className="text-sm text-secondary max-w-[80%]">Dobro dosli nazad! Prijavite se na svoj nalog i nastavite sa pregledanjem oglasa</p>
                    </div>
                    <div className="mt-2 flex flex-col gap-2">
                        <label className="text-sm" htmlFor="username-email">Korisnicko ime ili email adresa *</label>
                        <div className="w-full rounded-lg border border-border px-4 flex items-center justify-between gap-3">
                            <User className="w-6 h-6 text-secondary" />
                            <input type="text" id="username-email" placeholder="Unesite korisnicko ime ili email" className="h-12 flex-1 outline-none placeholder:text-sm placeholder:text-secondary" />
                        </div>
                    </div>
                    <div className="mt-2 flex flex-col gap-2">
                        <label className="text-sm" htmlFor="password">Lozinka *</label>
                        <div className="w-full rounded-lg border border-border px-4 flex items-center justify-between gap-3">
                            <LockKeyhole className="w-6 h-6 text-secondary" />
                            <input type="text" id="password" placeholder="Unesite lozinku" className="h-12 flex-1 outline-none placeholder:text-sm placeholder:text-secondary" />
                    ...
                    <div className="flex items-center justify-between mt-2">
                        <div className="flex items-center gap-2">
                            ...
                            <label htmlFor="remember-me" className="text-sm text-secondary leading-3">Zapamti me</label>
                        </div>
                        <Link href="#" className="text-sm text-primary font-medium">Zaboravili ste lozinku?</Link>
                    </div>
                    <div className="w-30 h-30 rounded-bl-full bg-[#f9f0f4] absolute top-0 right-0 flex items-center justify-center">
                        <SmartphoneCharging className="w-12 h-12 text-primary transform translate-x-4 -translate-y-3 rotate-12 opacity-45" />
                    </div>
                    <div className="mt-2">
                        <PrimaryButton text="Prijavi se" href="" tailingIcon={ArrowRightCircle} className="w-full" />
                    </div>
            ...
            <div className="w-40 h-48 bg-[#f9f0f4] absolute bottom-0 left-0"></div>
        </div>
    </>
}