...
export default function Newsletter() {
  return (
    <section className="w-full max-w-7xl mx-auto mt-36 bg-[#fdf7f8] rounded-2xl px-12 py-6 flex items-center justify-between relative overflow-hidden">
      <div className="flex items-center gap-8 z-2 max-w-1/2">
        <div className="min-w-32 min-h-32 flex-nowrap bg-pink-light rounded-full flex items-center justify-center">
      ...
      <div className="w-125 h-96 bg-pink-light rounded-full absolute -right-32 -top-4"></div>
      <Image
        src="/icons/plane.svg"
        width={64}
        height={64}
