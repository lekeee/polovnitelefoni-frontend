...
export default function Navbar() {
  return (
    <nav className="w-full bg-white pb-3 shadow-soft">
      <div className="w-full max-w-7xl mx-auto flex flex-col items-center justify-between py-0 px-5">
        <div className="w-full flex items-stretch justify-between my-2.5">
          <div className="flex gap-6">
            <Link href="/" className="text-sm flex items-center gap-1">
              <ShieldQuestionMark className="w-5 h-5" />O nama
            </Link>
            <Link href="/" className="text-sm flex items-center gap-1">
        ...
        <div className="w-full flex items-stretch justify-between my-2.5">
          <div className="rounded-full bg-black px-4 py-2 text-sm w-75 h-12.5 flex items-center justify-between">
            <div className="flex items-center gap-2">
              <Image
                src="/icons/hamburger-menu-half.svg"
                alt="Logo"
                height={30}
                width={30}
          ...
          <div className="flex gap-8">
            <Link
              href="/"
              className="text-sm flex gap-2 h-full justify-center items-center border-b-2 border-primary"
            >
            ...
            <Link
              href="/"
              className="text-sm flex gap-2 h-full justify-center items-center"
            >
          ...
          <Link
            href="/"
            className="h-12.5 flex justify-center items-center gap-2"
          >
            <Image
              src="/icons/new-indicator.svg"
              alt="Logo"
              height={30}
              width={30}
              className="text-white"
